...
export class Backend implements backendInterface {
    ...
    async createRequest(arg0: string, arg1: string): Promise<void> {
    ...
    async getEntries(arg0: string): Promise<Array<LocationEntry>> {
        if (this.processError) {
            try {
    ...
    async submitLocation(arg0: string, arg1: string, arg2: number, arg3: number): Promise<boolean> {
        if (this.processError) {
            try {
